...
namespace CNX.UserService.WebApi.Controllers
{
    ...
    public class UserController : MainController
    {
        ...
        public UserController(IUserBusiness userBusiness,
                              ...
                              IMapper mapper,
                              INotifier notifier) : base(notifier, userBusiness)
        {
        ...
        public async Task<IActionResult> Create([FromBody] UserDto userDto) 
        {
            ...
            {
                Notify("An error ocurred while creating an user, please contact the support to fix it..", ex?.InnerException?.Message);
        ...
        public async Task<IActionResult> Login([FromBody] LoginDto login)
        {
            ...
            {
                Notify("Error while logging in, please contact the support to fix it.", e.InnerException?.Message);
                return CustomResponse();
            }
        }
        ...
        public ActionResult<User> ValidateJwt()
        {
            try
            {
                return CustomResponse(_userBusiness.ValidateJwt(IdentifyUser()));
            }
            catch (Exception e)
            {
                Notify("Error while validating user, please contact the support to fix it.", e.InnerException?.Message);
                return CustomResponse();
            }
        }
    }
